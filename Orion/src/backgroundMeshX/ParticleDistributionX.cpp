...
void ParticleDistributionX::setPtcleProcDistrib(InputFileData* InputData,
...
void ParticleDistributionX::setInfluenceRadii(InputFileData* InputData,
  ...
  if(minPtcleSupport >= particlesNum) {
    logFile<<"In ParticleDistributionX::setInfluenceRadii too less "
  ...
  default:
    ...
    logFile<<"In ParticleDistributionX::setInfluenceRadii Particle "
...
void ParticleDistributionX::setPtcleRadsDistDepend(InputFileData* InputData,
                                                  std::map<std::string,double>& modelData,
                                                  std::ofstream& logFile) {
  ...
  vector<ParticleX>& ptcls = particles;
  ...
  for(int i=0;i<numOfPtcls;i++) {
	...
	logFile<<"In ParticleDistributionX::setPtcleRadsDistDepend particle\n "
...
//    direction is usually added to the opposite direction (plus/minus)
//    but can be reduced by this parameter
void ParticleDistributionX::setPtcleRadsDistDepend2(InputFileData* InputData,
                                                   std::map<std::string,double>& modelData,
                                                   std::ofstream& logFile) {
...
void ParticleDistributionX::setPtcleRadsSupportDepend(InputFileData* InputData,
...
/**********************************************************************/
// Post-process all particles' influence radii.
void ParticleDistributionX::postProcInfRads(InputFileData* InputData,
                                           std::map<std::string,double>& modelData,
                                           std::ofstream& logFile) {
  ...
  for(int i=0;i<numOfPtcls;i++) {
    ...
    if(minRadius == 0) {
      logFile<<"Particle "<<i<<" has got a zero influence cube in \n"
	     <<"(ParticleDistributionX::postProcInfRads)!"<<endl;
      MPI_Abort(MPI_COMM_WORLD,1);
    }
...
void ParticleDistributionX::setPtclePtclsConn(InputFileData* InputData,
                                             std::map<std::string,double>& modelData,
                                             std::ofstream& logFile) {
...
void ParticleDistributionX::setPointPtclsConn(InputFileData* InputData,
                                             dbVector& coords,
                                             int& supportSize,
...
void ParticleDistributionX::setPointPtclsConn(InputFileData* InputData,
  ...
  for(int i=0;i<particlesNum;i++) {
	...
	logFile<<"In ParticleDistributionX::setPointPtclsConn particle "
...
void ParticleDistributionX::updateParticleCoords(InputFileData* InputData,
                                                dbVector& allDOF,
                                                std::map<std::string,double>& modelData,
                                                std::ofstream& logFile) {
...
void ParticleDistributionX::clearAllPtcleDOF(InputFileData* InputData,
...
void ParticleDistributionX::setAllExclLocalPtcleOrder(InputFileData* InputData,
                                                     std::ofstream& logFile) {
...
void ParticleDistributionX::mergeLocalPtcleVectors(InputFileData* InputData,
...
void ParticleDistributionX::deleteNonlocalPtcls(InputFileData* InputData,
                                               std::ofstream& logFile) {
...
void ParticleDistributionX::getAllPtcleCoords(InputFileData* InputData,
					     dbVector& allCoords,
					     std::map<std::string,double>& calcData,
					     std::map<std::string,double>& modelData,
					     std::ofstream& logFile) {
