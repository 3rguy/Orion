...
FEMDiscretising::FEMDiscretising(InputFileData* InputData,
    ...
    BackgroundMesh(InputData,logFile), ParticleDistribution(InputData,logFile) {
...
void FEMDiscretising::copyFEData(FEMGeometry* FEData,InputFileData* InputData,
...
void FEMDiscretising::setBGaussPtcleConn(
...
/************************************************************************/
// Determine the Gauss point distribution among the processors.
void FEMDiscretising::setGaussDistribution(
    InputFileData* InputData,std::map<std::string,double>& modelData,
    std::ofstream& logFile) {
  ...
  logFile<<"****** local fluid vol flux boundary Gauss points *******"<<endl;
...
// nodes.
void FEMDiscretising::setShapeFuncsOnGauss(
    InputFileData* InputData,std::map<std::string,double>& modelData,
...
void FEMDiscretising::setShapeFuncsOnBGauss(
    InputFileData* InputData,std::map<std::string,double>& modelData,
    std::ofstream& logFile,PetscViewer& viewerMPI,PetscViewer& viewerSEQ) {
...
void FEMDiscretising::setShapeFuncsOnPtcls(
    InputFileData* InputData,std::map<std::string,double>& modelData,
    std::ofstream& logFile,PetscViewer& viewerMPI,PetscViewer& viewerSEQ) {
  ...
  for(int i = 0;i < localGlobalPtcls.size();i++) {
    ...
    dbMatrix& firstDerivShapes = particles[ptcle].getFirstDerivShapes();
