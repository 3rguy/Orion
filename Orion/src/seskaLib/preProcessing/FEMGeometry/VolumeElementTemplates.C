...
double Tetra4ElementTemplate::N(int func,dbVector& coords) {
  ...
  if(Gauss_Point_Positioning == 1) {
    ...
    case 0:
      ...
      break;
    default:
      cerr << "Tetra4ElementTemplate has no function N" << func + 1 << "!"
          << endl;
...
double Tetra4ElementTemplate::dN(int func,int deriv,dbVector& coords) {
  ...
  case 3:
    ...
    break;
  default:
    cerr << "Tetra4ElementTemplate has no function dN" << func + 1 << "!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Tetra4ElementTemplate::getMetricFactor(std::vector<Particle>& particles,
...
double Cube8ElementTemplate::N(int func,dbVector& coords) {
  ...
  if(Gauss_Point_Positioning == 1) {
    ...
    case 1:
      ...
      break;
    default:
      cerr << "Cube8ElementTemplate has no function N" << func + 1 << "!"
          << endl;
      MPI_Abort(MPI_COMM_WORLD,1);
      break;
    }
...
double Cube8ElementTemplate::dN(int func,int deriv,dbVector& coords) {
  ...
  if(Gauss_Point_Positioning == 1) {
    ...
    default:
      cerr << "Cube8ElementTemplate has no function dN" << func + 1 << "!"
          << endl;
      MPI_Abort(MPI_COMM_WORLD,1);
      break;
    }
...
double Cube8ElementTemplate::dN1(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN1/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN2(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN2/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN3(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN3/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN4(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN4/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN5(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN5/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN6(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN6/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN7(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN7/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube8ElementTemplate::dN8(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube8ElementTemplate::dN8/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
void Cube8ElementTemplate::getJacobian(std::vector<Particle>& particles,
                                       intVector& nodes,dbVector& coords,
                                       dbMatrix& Jmat,std::ofstream& logFile) {

  using namespace std;

  if(Jmat.size() == 0) allocateArray(Jmat,3,3);
...
// Calculate the transformation and metric factor for the integration
// of a volume element's volume.
double Cube8ElementTemplate::getMetricFactor(std::vector<Particle>& particles,
                                             intVector& nodes,dbVector& coords,
                                             std::ofstream& logFile) {
  ...
  getJacobian(particles,nodes,coords,Jmat,logFile);
...
double Cube27ElementTemplate::N(int func,dbVector& coords) {
  ...
  if(Gauss_Point_Positioning == 1) {
    ...
    case 26:
      ...
      break;
    default:
      cerr << "Cube27ElementTemplate has no function N" << func + 1 << "!"
          << endl;
      MPI_Abort(MPI_COMM_WORLD,1);
      break;
    }
...
double Cube27ElementTemplate::N1(dbVector& coords) {
  return (1.0 / 8.0 * (pow(coords[0],2) + coords[0])
    * (pow(coords[1],2) + coords[1]) * (pow(coords[2],2) + coords[2]));
}
...
double Cube27ElementTemplate::N13(dbVector& coords) {
  return ( -1.0 / 4.0 * (pow(coords[0],2) + coords[0])
    * (pow(coords[1],2) + coords[1]) * (pow(coords[2],2) - 1.0));
}
...
double Cube27ElementTemplate::N21(dbVector& coords) {
  return (1.0 / 2.0 * (pow(coords[0],2) - 1.0) * (pow(coords[1],2) - 1.0)
...
double Cube27ElementTemplate::N27(dbVector& coords) {
  return ( -1.0 * (pow(coords[0],2) - 1.0) * (pow(coords[1],2) - 1.0)
    * (pow(coords[2],2) - 1.0));
}
...
double Cube27ElementTemplate::dN(int func,int deriv,dbVector& coords) {
  ...
  if(Gauss_Point_Positioning == 1) {
    ...
    case 26:
      ...
      break;
    default:
      cerr << "Cube27ElementTemplate has no function dN" << func + 1 << "!"
          << endl;
      MPI_Abort(MPI_COMM_WORLD,1);
      break;
    }
...
double Cube27ElementTemplate::dN1(int deriv,dbVector& coords) {
  ...
  case 0:
    return (1.0 / 8.0 * (2.0 * coords[0] + 1.0) * (pow(coords[1],2) + coords[1])
      * (pow(coords[2],2) + coords[2]));
    break;

  case 1:
    return (1.0 / 8.0 * (pow(coords[0],2) + coords[0]) * (2.0 * coords[1] + 1.0)
      * (pow(coords[2],2) + coords[2]));
    break;

  case 2:
    return (1.0 / 8.0 * (pow(coords[0],2) + coords[0])
      * (pow(coords[1],2) + coords[1]) * (2.0 * coords[2] + 1.0));
    break;

  default:
    cerr << "In Cube27ElementTemplate::dN1/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN2(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN2/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN3(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN3/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN4(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN4/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN5(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN5/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN6(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN6/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN7(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN7/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN8(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN8/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN9(int deriv,dbVector& coords) {
  ...
  case 0:
    return ( -1.0 / 2.0 * (coords[0]) * (pow(coords[1],2) + coords[1])
      * (pow(coords[2],2) + coords[2]));
    break;

  case 1:
    return ( -1.0 / 4.0 * (pow(coords[0],2) - 1.0) * (2.0 * coords[1] + 1.0)
      * (pow(coords[2],2) + coords[2]));
    break;
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN9/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN10(int deriv,dbVector& coords) {
  ...
  case 0:
    return ( -1.0 / 4.0 * (2.0 * coords[0] - 1.0) * (pow(coords[1],2) - 1.0)
      * (pow(coords[2],2) + coords[2]));
    break;

  case 1:
    return ( -1.0 / 2.0 * (pow(coords[0],2) - coords[0]) * (coords[1])
      * (pow(coords[2],2) + coords[2]));
    break;

  case 2:
    return ( -1.0 / 4.0 * (pow(coords[0],2) - coords[0])
      * (pow(coords[1],2) - 1.0) * (2.0 * coords[2] + 1.0));
    break;

  default:
    cerr << "In Cube27ElementTemplate::dN10/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN11(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN11/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN12(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN12/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN13(int deriv,dbVector& coords) {
  ...
  case 0:
    return ( -1.0 / 4.0 * (2.0 * coords[0] + 1.0)
      * (pow(coords[1],2) + coords[1]) * (pow(coords[2],2) - 1.0));
    break;

  case 1:
    return ( -1.0 / 4.0 * (pow(coords[0],2) + coords[0])
      * (2.0 * coords[1] + 1.0) * (pow(coords[2],2) - 1.0));
    break;

  case 2:
    return ( -1.0 / 2.0 * (pow(coords[0],2) + coords[0])
      * (pow(coords[1],2) + coords[1]) * (coords[2]));
    break;

  default:
    cerr << "In Cube27ElementTemplate::dN13/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN14(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN14/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN15(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN15/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN16(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN16/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN17(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN17/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN18(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN18/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN19(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN19/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN20(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN20/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN21(int deriv,dbVector& coords) {
  ...
  case 0:
    return ((coords[0]) * (pow(coords[1],2) - 1.0)
      * (pow(coords[2],2) + coords[2]));
    break;

  case 1:
    return ((pow(coords[0],2) - 1.0) * (coords[1])
      * (pow(coords[2],2) + coords[2]));
    break;
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN21/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN22(int deriv,dbVector& coords) {
  ...
  case 0:
    return ((coords[0]) * (pow(coords[1],2) + coords[1])
      * (pow(coords[2],2) - 1.0));
    break;

  case 1:
    return (1.0 / 2.0 * (pow(coords[0],2) - 1.0) * (2.0 * coords[1] + 1.0)
      * (pow(coords[2],2) - 1.0));
    break;

  case 2:
    return ((pow(coords[0],2) - 1.0) * (pow(coords[1],2) + coords[1])
      * (coords[2]));
    break;

  default:
    cerr << "In Cube27ElementTemplate::dN22/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN23(int deriv,dbVector& coords) {
  ...
  case 0:
    return (1.0 / 2.0 * (2.0 * coords[0] - 1.0) * (pow(coords[1],2) - 1.0)
      * (pow(coords[2],2) - 1.0));
    break;

  case 1:
    return ((pow(coords[0],2) - coords[0]) * (coords[1])
      * (pow(coords[2],2) - 1.0));
    break;

  case 2:
    return ((pow(coords[0],2) - coords[0]) * (pow(coords[1],2) - 1.0)
      * (coords[2]));
    break;

  default:
    cerr << "In Cube27ElementTemplate::dN23/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN24(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN24/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN25(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN25/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN26(int deriv,dbVector& coords) {
  ...
  default:
    cerr << "In Cube27ElementTemplate::dN26/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
double Cube27ElementTemplate::dN27(int deriv,dbVector& coords) {
  ...
  case 0:
    return ( -2.0 * (coords[0]) * (pow(coords[1],2) - 1.0)
      * (pow(coords[2],2) - 1.0));
    break;

  case 1:
    return ( -2.0 * (pow(coords[0],2) - 1.0) * (coords[1])
      * (pow(coords[2],2) - 1.0));
    break;

  case 2:
    return ( -2.0 * (pow(coords[0],2) - 1.0) * (pow(coords[1],2) - 1.0)
      * (coords[2]));
    break;

  default:
    cerr << "In Cube27ElementTemplate::dN27/dL" << deriv << " not available!"
        << endl;
    MPI_Abort(MPI_COMM_WORLD,1);
    break;
  }
...
void Cube27ElementTemplate::getJacobian(std::vector<Particle>& particles,
                                        intVector& nodes,dbVector& coords,
                                        dbMatrix& Jmat,std::ofstream& logFile) {
...
// Calculate the transformation and metric factor for the integration
// of a volume element's volume.
double Cube27ElementTemplate::getMetricFactor(std::vector<Particle>& particles,
                                              intVector& nodes,dbVector& coords,
                                              std::ofstream& logFile) {
