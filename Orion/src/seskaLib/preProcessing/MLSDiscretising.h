...
class MLSDiscretising : public virtual ModifiedMLSGauss,
			public virtual MLSGaussIntegral, 
  ...
  public:
    ...
    void getAllPtcleDOF(InputFileData* InputData,
			dbVector& allDOF,
			std::map<std::string,double>& calcData,
			std::map<std::string,double>& modelData,
			std::ofstream& logFile);
    ...
    void getAllPtcleDispDOF(InputFileData* InputData,
			    dbVector& allDOF,
			    std::map<std::string,double>& calcData,
			    std::map<std::string,double>& modelData,
			    std::ofstream& logFile);
    ...
    intMatrix& getPointForceBoundPtcleIdx(InputFileData* InputData,
					  std::map<std::string,double>& modelData,
					  std::ofstream& logFile);
    ...
    const int& getMaxBoundPtcleSupport() { return maxBoundPtcleSupport; };
