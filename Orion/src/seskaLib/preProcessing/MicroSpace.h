...
class MicroSpace {
 ...
 public:
  ...
  dbVector& getMicroRotationVec(InputFileData* InputData,std::ofstream& logFile);
  ...
  void setInitialMicroDirections(InputFileData* InputData,
                                 dbVector& coords,
  ...
  void setMicroMetrics(InputFileData* InputData,
		       dbVector& coords,
		       std::map<std::string,double>& calcData,
		       std::map<std::string,double>& modelData,
		       std::ofstream& logFile);
