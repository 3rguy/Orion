...
Particle::Particle(int usedDOF) : ID(0),depolarisationTime(0),
...
void Particle::setID(int idx) {

  ID = idx;
}

void Particle::setWeight(int ID,double value) {
...
double& Particle::getIntWeight(int ID) { 
...
void Particle::setElems(int elem) {
...
void Particle::setCoords(double coord1,double coord2,double coord3) {
...
void Particle::setRadii(double& rx,double& ry,double& rz) {
...
void Particle::setDOF(int idx,double& value) {


  degreesOfFreedom[idx] = value;
}

void Particle::setDOFs(dbVector& dofs) {

  degreesOfFreedom = dofs;
}

void Particle::setOldDOF(int idx,double& value) {
  
  
  oldDegreesOfFreedom[idx] = value;
}

void Particle::setOldDOFs(dbVector& dofs) {
  
  oldDegreesOfFreedom = dofs;
}


void Particle::setLocalMinPtcleDistance(double localMinPtcleDist) {

  localMinPtcleDistance = localMinPtcleDist;
}

void Particle::setBeta(double betaVal) {

  beta = betaVal;
}


void Particle::setBetaDerivs(dbVector betaDer) {

  betaDerivs = betaDer;
}


void Particle::setShapeFuncsSize(int& size,int& order) {
...
void Particle::setShapeFuncs(int& size,dbVector& sFuncs) {
...
void Particle::setFirstDerivShapes(int& size,
...
void Particle::setSecondDerivShapes(int& size,
...
void Particle::setInflSpheres(int& size,intVector& iSpheres) {
...
/***********************************************************************/
void Particle::setNBShapeFuncs(int& DOF,int& supportSize,
                               dbVector& shapes) {
...
void Particle::setBShapeFunc(int& DOF,int& idx,double& value) {
...
void Particle::setNBShapeFunc(int& DOF,int& idx,double& value) {
...
/***********************************************************************/
double& Particle::getSurfacePressure(int ID) { 
...
blVector& Particle::getBodyForceDOF(int ID) { 
...
dbVector& Particle::getBodyForce(int ID) { 
...
blVector& Particle::getTractionDOF(int ID) { 
...
dbVector& Particle::getTraction(int ID) { 
...
blVector& Particle::getLineForceDOF(int ID) { 
...
dbVector& Particle::getLineForce(int ID) { 
...
blVector& Particle::getPointForceDOF(int ID) { 
...
dbVector& Particle::getPointForce(int ID) { 
...
dbVector& Particle::getSurfaceNormal(int ID) { 
...
blVector& Particle::getDeformationBoundDOF(int ID) { 
...
dbVector& Particle::getDeformationBoundConds(int ID) { 
...
dbVector& Particle::getDeltaDeformationBoundConds(int ID) { 
...
dbVector& Particle::getInitialDeformationBoundConds(int ID) { 
...
blVector& Particle::getElectricBoundDOF(int ID) { 
...
dbVector& Particle::getElectricBoundConds(int ID) { 
...
dbVector& Particle::getDeltaElectricBoundConds(int ID) { 
...
dbVector& Particle::getInitialElectricBoundConds(int ID) { 
...
blVector& Particle::getDepolarisationBoundDOF(int ID) { 
...
dbVector& Particle::getDepolarisationBoundConds(int ID) { 
...
dbVector& Particle::getDeltaDepolarisationBoundConds(int ID) { 
...
dbVector& Particle::getInitialDepolarisationBoundConds(int ID) { 
...
blVector& Particle::getMicroBoundDOF(int ID) { 
...
dbVector& Particle::getMicroBoundConds(int ID) { 
...
dbVector& Particle::getDeltaMicroBoundConds(int ID) { 
...
dbVector& Particle::getInitialMicroBoundConds(int ID) { 
...
dbMatrix& Particle::getDeformationGradient() {
...
dbMatrix& Particle::getIntermediateDefGradient() {
...
double& Particle::getIntermediateJacobian() {
...
bool Particle::querySupported(InputFileData* InputData,
