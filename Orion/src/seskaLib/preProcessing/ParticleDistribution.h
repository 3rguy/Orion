...
public:
  ...
  ParticleDistribution(InputFileData* InputData,std::ofstream& logFile) :
    ...
    void setPtcleRadsDistDepend(InputFileData* InputData,
      ...
      setPtcleRadsDistDepend(InputData,particles,modelData,logFile);
    ...
    void postProcInfRads(InputFileData* InputData,
                         std::map<std::string,double>& modelData,
                         std::ofstream& logFile) {
      postProcInfRads(InputData,particles,modelData,logFile);
    };
    ...
    std::vector<Particle>& getParticlesVec() { return particles; };
